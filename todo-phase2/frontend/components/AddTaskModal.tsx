        ...
        <div className="relative bg-gray-900 rounded-lg max-w-md w-full mx-auto p-6 shadow-xl border border-green-500" role="dialog" aria-modal="true" aria-labelledby="modal-title">
          ...
          <div className="mt-2">
            ...
            <form onSubmit={handleSubmit} className="mt-4 space-y-4 font-mono">
              <div>
                <label htmlFor="title-input" className="block text-sm font-medium text-green-400">
                  TITLE *
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="description-input" className="block text-sm font-medium text-green-400">
                  DESCRIPTION
                </label>
                <textarea
